...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::mfa_totp_verify,
            commands::mfa_totp_disable,
            ...
            commands_admin::admin_alerts_list,
            commands_admin::admin_alert_create,
            commands_admin::admin_alert_update,
            commands_admin::admin_alert_delete,
            commands_admin::admin_homepage_alerts_list,
            commands_admin::admin_homepage_alert_create,
            commands_admin::admin_homepage_alert_update,
            commands_admin::admin_homepage_alert_delete,
            commands_admin::admin_incidents_list,
            commands_admin::admin_incident_create,
            commands_admin::admin_incident_add_update,
            commands_admin::admin_incident_update,
            commands_admin::admin_incident_delete,
            commands_admin::admin_settings_email_get,
            commands_admin::admin_settings_email_update,
            commands_admin::admin_settings_email_test,
            commands_admin::admin_settings_steam_get,
            commands_admin::admin_settings_steam_update,
            commands_admin::admin_settings_steam_verify,
            commands_admin::admin_settings_vanity_get,
            commands_admin::admin_settings_vanity_update,
            commands_admin::admin_settings_referrals_get,
            commands_admin::admin_settings_referrals_update,
            commands_admin::admin_database_hosts_list,
            commands_admin::admin_database_host_create,
            commands_admin::admin_database_host_update,
            commands_admin::admin_database_host_delete,
            commands_admin::admin_database_host_test,
            commands_admin::admin_products_list,
            commands_admin::admin_product_get,
            commands_admin::admin_product_create,
            commands_admin::admin_product_update,
            commands_admin::admin_product_delete,
            commands_admin::admin_price_create,
            commands_admin::admin_tier_price_create,
            commands_admin::admin_price_update,
            commands_admin::admin_price_delete,
            commands_admin::admin_tier_create,
            commands_admin::admin_tier_update,
            commands_admin::admin_tier_delete,
            commands_admin::admin_staff_list,
            commands_admin::admin_staff_create,
            commands_admin::admin_staff_update,
            commands_admin::admin_staff_delete,
            commands_admin::admin_templates_list,
            commands_admin::admin_template_get,
        ])
